...
<div class="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <ul class="accordion-box style-two mb-30">
                        ...
                        <li class="accordion block">
                            <div class="acc-btn active">What is Indasto?</div>
                            <div class="acc-content current">
                                <div class="content">
                                    <div class="text">The wise man therefore always holds in these matters to this principle of selections he rejects pleasures too secure other greater pleasures.
                                    </div>
                                </div>
                            </div>
                        </li>
                        ...
                        <!--Accordion Block-->
                        <li class="accordion block">
                            <div class="acc-btn">How to Start?</div>
                        ...
                        <!--Accordion Block-->
                        <li class="accordion block">
                            <div class="acc-btn">How to Schedule a Appointment?</div>
                            <div class="acc-content">
                                <div class="content">
                                    <div class="text">The wise man therefore always holds in these matters to this principle of selections he rejects pleasures too secure  other greater pleasures.
                                    </div>
                        ...
                        <!--Accordion Block-->
                        <li class="accordion block">
                            <div class="acc-btn">What Your Certifications?</div>
                            <div class="acc-content">
                                <div class="content">
                                    <div class="text">The wise man therefore always holds in these matters to this principle of selections he rejects pleasures too secure  other greater pleasures.
                                    </div>
                ...
                <div class="col-lg-6">
                    <ul class="accordion-box style-two mb-30">
                        <!--Accordion Block-->
                        <li class="accordion block">
                            <div class="acc-btn active">What is Your Pricing & Plans?</div>
                            <div class="acc-content current">
                                <div class="content">
                                    <div class="text">The wise man therefore always holds in these matters to this principle of selections he rejects pleasures too secure  other greater pleasures.
                                    </div>
                        ...
                        <!--Accordion Block-->
                        <li class="accordion block">
                            <div class="acc-btn">What are the Methods of Manufacturing?</div>
                            <div class="acc-content">
                                <div class="content">
                                    <div class="text">The wise man therefore always holds in these matters to this principle of selections he rejects pleasures too secure  other greater pleasures.
                                    </div>
                        ...
                        <!--Accordion Block-->
                        <li class="accordion block">
                            <div class="acc-btn">How Long Has Indasto Manufacturing?</div>
                            <div class="acc-content">
                                <div class="content">
                                    <div class="text">The wise man therefore always holds in these matters to this principle of selections he rejects pleasures too secure  other greater pleasures.
                                    </div>
                        ...
                        <!--Accordion Block-->
                        <li class="accordion block">
                            <div class="acc-btn">What is Production Planning?</div>
                            <div class="acc-content">
                                <div class="content">
                                    <div class="text">The wise man therefore always holds in these matters to this principle of selections he rejects pleasures too secure  other greater pleasures.
                                    </div>
    ...
    <section class="testimonials-section-five style-two">
        <div class="sec-bg" style="background-image: url(images/background/bg-27.jpg);"></div>
        <div class="auto-container">
                     ...
                     <div class="contact-form">
                        ...
                        <form method="post" action="inc/sendmail.php" id="contact-form">
                            <div class="row">
                                ...
                                <div class="form-group col-lg-6">
                                    <input id="phone" type="text" name="email" value="" placeholder="Your Email" required>
                                </div>
                                <div class="form-group col-lg-12">
                                ...
                                <div class="form-group col-lg-12">
                                    <div class="form-btn">
                                        ...
                                        <button class="theme-btn style-four w-100" type="submit" data-loading-text="Please wait..."><span>Get Call Back</span></button>
                                    </div>
                                </div>
                            </div>
                        </form>
    ...
    <!-- Client logo section -->
    <section class="clients-logo-section style-four">
        <div class="auto-container">
            <div class="theme_carousel owl-theme owl-carousel" data-options='{"loop": true, "center": false, "margin": 0, "autoheight":true, "lazyload":true, "nav": true, "dots": true, "autoplay": true, "autoplayTimeout": 6000, "smartSpeed": 1000, "responsive":{ "0" :{ "items": "1" }, "480" :{ "items" : "1" }, "600" :{ "items" : "2" }, "768" :{ "items" : "3" } , "992":{ "items" : "4" }, "1200":{ "items" : "4" }}}'>
                <div class="single-client-logo">
                    <img src="images/resource/client-logo-6.png" alt="">
                </div>
                <div class="single-client-logo">
                    <img src="images/resource/client-logo-7.png" alt="">
                </div>
                <div class="single-client-logo">
                    <img src="images/resource/client-logo-8.png" alt="">
                </div>
                <div class="single-client-logo">
                    <img src="images/resource/client-logo-9.png" alt="">
                </div>
                <div class="single-client-logo">
                    <img src="images/resource/client-logo-6.png" alt="">
                </div>
