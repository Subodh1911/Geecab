...
<link rel="shortcut icon" href="images/favicon-two.png" type="image/x-icon">
<link rel="icon" href="images/favicon-two.png" type="image/x-icon">
...
<div class="page-wrapper">
                    ...
                    <div class="right-column">
                        <div class="contact-info">
                            <div class="single-contact-info">
                                ...
                                <h4>Office</h4>
                                <div class="text">191 Integer Rd, LA 08219 </div>
                            </div>
                            <div class="single-contact-info">
                                <div class="icon"><span class="flaticon-call"></span></div>
                                <h4>Phone</h4>
                                <div class="text"><a href="tel:+08963648018">+089 636-48018</a></div>
                            </div>
                            <div class="single-contact-info">
                                <div class="icon"><span class="flaticon-correspondence"></span></div>
                                <h4>Email</h4>
                                <div class="text"><a href="mailto:info@indasto.com">info@indasto.com</a></div>
                            </div>
                        </div>
                    </div>                        
                </div>
            ...
            <div class="auto-container">
                <div class="wrapper-box">
                    ...
                    <div class="navbar-right-info">
                        ...
                        <div class="side-menu-nav sidemenu-nav-toggler"><img src="images/icons/icon-bar-4.png" alt=""></div>
                    </div>
                </div>
            </div>
    ...
    <section class="banner-section style-two">
        <div class="swiper-container banner-slider">
            <div class="swiper-wrapper">
                <!-- Slide Item -->
                <div class="swiper-slide" style="background-image: url(images/main-slider/image-4.jpg);">
                ...
                <!-- Slide Item -->
                <div class="swiper-slide" style="background-image: url(images/main-slider/image-5.jpg);">
                    <div class="content-outer">
                        <div class="content-box">
                            <div class="inner">
                ...
                <!-- Slide Item -->
                <div class="swiper-slide" style="background-image: url(images/main-slider/image-6.jpg);">
                    <div class="content-outer">
                        <div class="content-box">
                            <div class="inner">
    ...
    <section class="about-section-two">
        <div class="auto-container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="image"><img src="images/resource/image-22.jpg" alt=""></div>
                </div>
                <div class="col-lg-6">
    ...
    <!-- Facts section -->
    <!-- <section class="facts-section-two" style="background-image: url(images/background/bg-3.jpg);">
        <div class="auto-container">
            <div class="row">
                <div class="col-lg-6">
                ...
                <div class="col-lg-6">
                    <div class="wrapper-box" style="background-image: url(images/resource/image-40.jpg);">
                        <div class="row">
                            ...
                            <div class="col-md-6 column facts-block-two">
                                <div class="inner wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                                    <div class="content">
                                        ...
                                        <div class="link"><a href="#" class="link-btn">Our Location <i class="flaticon-right-arrow-3"></i></a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <section class="whychoose-us-section" style="background-image: url(images/background/bg-7.jpg);">
        <div class="auto-container">
    ...
    <section class="projects-section-two">
        <div class="sec-bg" style="background-image: url(images/background/bg-4.jpg);"></div>
        <div class="auto-container">
            ...
            <div class="filters">
                ...
                <div class="link"><a href="#" class="link-btn">All Projects <i class="flaticon-right-arrow-3"></i></a></div>
            </div>
            ...
            <div class="sortable-masonry">
                ...
                <div class="items-container row">
                    ...
                    <div class="col-lg-3 col-md-6 project-block masonry-item all cat-1">
                        <div class="inner-box">
                            <div class="image">
                                <img src="images/resource/image-23.jpg" alt="">
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 project-block masonry-item all cat-4">
                        <div class="inner-box">
                            <div class="image">
                                <img src="images/resource/image-24.jpg" alt="">
                            </div>
                            <div class="overlay-content">
                                <div>
                                    <div class="category"># Welding</div>
                    ...
                    <div class="col-lg-3 col-md-6 project-block masonry-item all cat-1 cat-3">
                        <div class="inner-box">
                            <div class="image">
                                <img src="images/resource/image-25.jpg" alt="">
                            </div>
                            <div class="overlay-content">
                                <div>
                                    <div class="category"># Welding</div>
                    ...
                    <div class="col-lg-3 col-md-6 project-block masonry-item all cat-2 cat-5">
                        <div class="inner-box">
                            <div class="image">
                                <img src="images/resource/image-26.jpg" alt="">
                            </div>
                            <div class="overlay-content">
                                <div>
                                    <div class="category"># Welding</div>
                    ...
                    <div class="col-lg-3 col-md-6 project-block masonry-item all cat-3 cat-2">
                        <div class="inner-box">
                            <div class="image">
                                <img src="images/resource/image-27.jpg" alt="">
                            </div>
                            <div class="overlay-content">
                                <div>
                                    <div class="category"># Welding</div>
                    ...
                    <div class="col-lg-3 col-md-6 project-block masonry-item all cat-1">
                        <div class="inner-box">
                            <div class="image">
                                <img src="images/resource/image-28.jpg" alt="">
                            </div>
                            <div class="overlay-content">
                                <div>
                                    <div class="category"># Welding</div>
                    ...
                    <div class="col-lg-3 col-md-6 project-block masonry-item all cat-4 cat-5">
                        <div class="inner-box">
                            <div class="image">
                                <img src="images/resource/image-29.jpg" alt="">
                            </div>
                            <div class="overlay-content">
                                <div>
                                    <div class="category"># Welding</div>
                    ...
                    <div class="col-lg-3 col-md-6 project-block masonry-item all cat-1 cat-5 cat-3">
                        <div class="inner-box">
                            <div class="image">
                                <img src="images/resource/image-30.jpg" alt="">
                            </div>
                            <div class="overlay-content">
                                <div>
                                    <div class="category"># Welding</div>
    ...
    <!-- <section class="pricing-section">
        <div class="sec-bg" style="background-image: url(images/background/bg-5.jpg);"></div>
        <div class="auto-container">
            <div class="row m-0 top-content justify-content-between align-items-center">
                <div class="sec-title light">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 pricing-block">
                    <div class="inner-box wow fadeInUp" data-wow-duration="1500ms">
                        ...
                        <div class="link-btn"><a href="#" class="theme-btn"><span>Get Started <i class="flaticon-right-arrow-3"></i></span></a></div>
                        <ul class="content">
                            <li>Laser Cutting</li>
                            <li>Machining</li>
                            <li>Fabrication</li>
    ...
    <section class="contact-form-section style-two" style="background-image: url(images/background/bg-6.jpg);">
        <div class="auto-container">
            <div class="sec-title text-center">
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="feature-block-two style-two">
                        <div class="inner-box">
                            <div class="icon"><img src="images/icons/icon-43.png" alt=""></div>
                            <h4>Subscribe Our <br> Newsletter</h4>
                            <div class="text">Subscribe us & get updates in inbox</div>
                            <div class="link-btn"><a href="#" class="theme-btn style-three"><span>Enter Email</span></a></div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="cta-section-two">
        <div class="auto-container">
            <div class="wrapper-box" style="background-image: url(images/background/bg-8.jpg);">
                <div class="row">
                    <div class="col-lg-8">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="widget contact-widget-two">
                            ...
                            <h5><i class="flaticon-geolocation"></i> 191 Integer Rd, 2nd Street <br>LA 08219 USA.</h5>
                            <div class="text">Indasto is your one-call solution  for a wide <br> range of manufactory & industry solutions, <br> Services since 2006.</div>
                            <ul class="contact-info">
                                <li><img src="images/resource/author-6.jpg" alt=""></li>
