    ...
    <section class="page-title" style="background-image: url(images/background/bg-26.jpg);">
        <div class="auto-container">
            <div class="content-box">
                <div class="content-wrapper">
                    <div class="title">
                        <h1>Our Leaders 03</h1>
                    </div>
                    <ul class="bread-crumb style-two">
                        <li><a href="index.html">Home </a></li>
                        <li><a href="#">Pages </a></li>
                        <li class="active">Our Leaders</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="auto-container">
            ...
            <div class="row">
                <div class="theme_carousel owl-theme owl-carousel" data-options='{"loop": true, "center": false, "margin": 0, "autoheight":true, "lazyload":true, "nav": true, "dots": true, "autoplay": true, "autoplayTimeout": 6000, "smartSpeed": 1000, "responsive":{ "0" :{ "items": "1" }, "480" :{ "items" : "1" }, "768" :{ "items" : "2" } , "992":{ "items" : "3" }, "1200":{ "items" : "4" }}}'>
                    <div class="team-block-three col-lg-12">
                        <div class="inner-box">
                            ...
                            <div class="image"><img src="images/resource/image-94.jpg" alt=""></div>
                            <h4>Dillon Bruno</h4>
                        </div>
                    </div>
                    <div class="team-block-three col-lg-12">
                        <div class="inner-box">
                            ...
                            <div class="image"><img src="images/resource/image-95.jpg" alt=""></div>
                            <h4>Boris Evan</h4>
                        </div>
                    </div>
                    <div class="team-block-three col-lg-12">
                        <div class="inner-box">
                            ...
                            <div class="image"><img src="images/resource/image-96.jpg" alt=""></div>
                            <h4>Gerald Ivor</h4>
                        </div>
                    </div>
                    <div class="team-block-three col-lg-12">
                        <div class="inner-box">
                            ...
                            <div class="image"><img src="images/resource/image-97.jpg" alt=""></div>
                            <h4>Mark Kevin</h4>
                        </div>
                    </div>
                    <div class="team-block-three col-lg-12">
