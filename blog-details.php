                    ...
                    <div class="news-block-two blog-single-post">
                        <div class="inner-box">
                            ...
                            <div class="lower-content">                                
                                <div class="text mb-40">How all this mistaken idea of denouncing pleasure and praising pain was born and I will give you a complete account of the system and expound the actual teachings of the great explorer of the truth master builder of human happiness. No one rejects, dislikes, or avoids pleasure itself, because it is pleasure because those who do not know how pursue pleasure rationally encounter consequences that are extremely.</div>  
                                <h4>Production Facilities </h4>
                                <div class="text mb-40">In a free hour when our power of choice is untrammelled and when nothing prevents our being able to do what we like best, every pleasure is to be welcomed and every pain avoided but in certain circumstances and owing to the claims of duty.</div>
                                <blockquote>
                                    <div class="quote-icon"><i class="flaticon-right-quote-1"></i>                                    </div>
                                    We’re glad to announce that Indasto won supplier quality excellence award for 2020 performance.
                                </blockquote> 
                                <h4>Product Range</h4>   
                                <div class="text mb-40">Denounce with righteous indignation and dislike men who are so beguiled and demoralized by the charms of pleasure of the moment, so blinded by desire, that they cannot foresee the pain and trouble that are bound to ensue.</div>     
                                <h4>Quality Control</h4>   
                                <div class="text mb-40">
                                    <p>These cases are perfectly simple and easy to distinguish. In a free hour, when our power off choice is untrammelled and when nothing.</p>
                                    <p>Every pleasure is to be welcomed and every pain avoided. But in certain circumstances and owing to the claims of duty or the obligations of business it will frequently. </p>
                                </div> 
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        <div class="image"><img src="images/blog/image-20.jpg" alt=""></div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="image"><img src="images/blog/image-21.jpg" alt=""></div>
                                    </div>
                                </div> 
                                <h4>Research & Development</h4>
                                <div class="text mb-40">
                                    <p>Occur that pleasures have to be repudiated all annoyances accepted. The wise man therefore always holds in these matters to this principle of selection.</p>
                                    <p>Indignation and dislike men who are so beguiled and demoralized  by the charms pleasure.</p>
                                    <p>Rejects pleasures to secure other greater pleasures endures pains.</p>
                                    <p>foresee the pain and trouble that are bound to ensue; and equal blame belongs to those who fail in their duty through weakness.</p>
                                </div>
                                <ul class="list mb-40">
                        ...
                        <div class="comments-area">
                            ...
                            <div class="comment-box">
                                <div class="comment">
                                    ...
                                    <div class="comment-inner">
                                        <div class="comment-info">Isaac Herman<span class="date">February 28, 2020 [ 11.00am]</span></div>
                            ...
                            <div class="comment-box reply-comment">
                                <div class="comment">
                                    ...
                                    <div class="comment-inner">
                                        <div class="comment-info">William Cobus <span class="date">February 28, 2020 [11.12am]</span></div>
                                        <div class="text">How all this mistaken idea of denouncing pleasure and praising pain was born and I will give you a complete account of the system.</div>
                                        <a class="reply-comment-btn" href="#"><i class="flaticon-reply"></i> Reply</a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="comment-form">  
                            ...
                            <form method="post">
                                <div class="row row-5">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                                        <button class="theme-btn btn-style-one" type="submit" name="submit-form"><span class="btn-title"><i class="flaticon-up-arrow"></i>Post Comment</span></button>
                                    </div>
                                </div>
                            </form>
                        </div>
                    ...
                    <div class="blog-sidebar">
                        ...
                        <div class="widget widget_categories">
                            ...
                            <div class="widget-content">
                                <ul class="categories-list clearfix">
                                    <li><a href="#">Innovation <span>(04)</span></a></li>
                                    <li><a href="#"> Manufacturing <span>(12)</span></a></li>
                                    <li><a href="#">Materials <span>(07)</span></a></li>
                                    <li><a href="#">Smart Factory <span>(06)</span></a></li>
                                    <li><a href="#">Technology <span>(05)</span></a></li>
                                </ul>
                            </div>
                        </div>
                        <!-- news widget -->
                        <div class="news-widget widget">
                            ...
                            <div class="news-content">
                                <h4><a href="blog-details.php">Gas shield solution developed <br>  for the aerospace ... <i class="flaticon-arrow-1"></i></a></h4>
                                <h4><a href="blog-details.php">How to locate best leather bag <br>  manufacturer? ... <i class="flaticon-arrow-1"></i></a></h4>
                                <h4><a href="blog-details.php">Gas shield solution developed <br>  for the aerospace ... <i class="flaticon-arrow-1"></i></a></h4>
                            </div>
                        </div>
                        <!-- Instagram widget -->
